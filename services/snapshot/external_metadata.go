...
// ============================================================================
// External Snapshot Metadata Management
// ============================================================================
// The metadata in this file is used as the source of truth for external
// snapshot chain operations.

// defaultSnapshotRoot is the default base directory for storing external snapshots.
...
// resolveSnapshotRoot validates and resolves the snapshot storage root directory.
// If no base directory is specified in opts, it returns the default.
// Otherwise, it validates that the provided path is absolute and safe.
